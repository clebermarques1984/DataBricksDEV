...
# Writing to tables
utils.write_stream_to_table(spark, df_roads_tr, catalog, database, 'gold_roads', ws_rootpath)
utils.write_stream_to_table(spark, df_traffic_tr, catalog, database, 'gold_traffic', ws_rootpath)
